...
#include "BME680mixIR.h"  // Include the library header definition
/***************************************************************************************************
** Declare IR thermometer                                                    **
***************************************************************************************************/
const uint8_t MLX90614_DEFAULT_ADDRESS{0x5A};
///////////////////////////////////////
// MLX90614 RAM and EEPROM Addresses //
///////////////////////////////////////
/*
const uint8_t MLX90614_REGISTER_TA{0x06};
const uint8_t MLX90614_REGISTER_TOBJ1{0x07};
const uint8_t MLX90614_REGISTER_TOBJ2{0x08};
const uint8_t MLX90614_REGISTER_TOMAX{0x20};
const uint8_t MLX90614_REGISTER_TOMIN{0x21};
const uint8_t MLX90614_REGISTER_PWMCTRL{0x22};
const uint8_t MLX90614_REGISTER_TARANGE{0x23};
const uint8_t MLX90614_REGISTER_KE{0x24};
const uint8_t MLX90614_REGISTER_CONFIG{0x25};
const uint8_t MLX90614_REGISTER_ADDRESS{0x2E};
const uint8_t MLX90614_REGISTER_ID0{0x3C};
const uint8_t MLX90614_REGISTER_ID1{0x3D};
const uint8_t MLX90614_REGISTER_ID2{0x3E};
const uint8_t MLX90614_REGISTER_ID3{0x3F};
const uint8_t MLX90614_REGISTER_SLEEP{0xFF}; // Not really a register, but close enough
*/
/***************************************************************************************************
...
mixTempSens_Class::mixTempSens_Class() {
...
bool mixTempSens_Class::beginIR(uint8_t addr, TwoWire *wire) {
 ...
 */
uint16_t mixTempSens_Class::readEmissivityReg(void) {
 ...
 */
void mixTempSens_Class::writeEmissivityReg(uint16_t ereg) {
 ...
 * failed
 */
double mixTempSens_Class::readEmissivity(void) {
 ...
 */
void mixTempSens_Class::writeEmissivity(double emissivity) {
 ...
 */
double mixTempSens_Class::readObjectTempF(void) {
 ...
 * @return double The temperature in degrees Farenheit or NAN if reading failed
 */
double mixTempSens_Class::readAmbientTempF(void) {
 ...
 */
double mixTempSens_Class::readObjectTempC(void) {
 ...
 * @return double The temperature in degrees Celcius or NAN if reading failed
 */
double mixTempSens_Class::readAmbientTempC(void) {
  return readTemp(MLX90614_TA);
}

float mixTempSens_Class::readTemp(uint8_t reg) {
  float temp;
...
/*********************************************************************/
uint16_t mixTempSens_Class::read16(uint8_t a) {
  uint8_t buffer[3];
  buffer[0] = a;
...
byte mixTempSens_Class::crc8(byte *addr, byte len)
...
void mixTempSens_Class::write16(uint8_t a, uint16_t v) {
  uint8_t buffer[4];
...
bool mixTempSens_Class::begin(const uint32_t i2cSpeed) {
  /*!
  @brief   starts communications with device (overloaded)
...
bool mixTempSens_Class::begin(const uint32_t i2cSpeed, const uint8_t i2cAddress) {
  /*!
  @brief   starts communications with device (overloaded)
  @details When called with a 32-bit parameter it is assumed that the I2C protocol is to be used
...
bool mixTempSens_Class::begin(const uint8_t chipSelect) {
  /*!
  @brief     starts communications with device (overloaded)
...
bool mixTempSens_Class::begin(const uint8_t chipSelect, const uint8_t mosi, const uint8_t miso,
                         const uint8_t sck) {
  /*!
  @brief   starts communications with device (overloaded)
...
bool mixTempSens_Class::commonInitialization() {
  /*!
...
uint8_t mixTempSens_Class::readByte(const uint8_t addr) const {
...
void mixTempSens_Class::getCalibration() {
  /*!
...
uint8_t mixTempSens_Class::setOversampling(const uint8_t sensor, const uint8_t sampling) const {
  /*!
...
uint8_t mixTempSens_Class::setIIRFilter(const uint8_t iirFilterSetting) const {
  /*!
...
uint8_t mixTempSens_Class::getSensorData(int32_t& temp, int32_t& hum, int32_t& press, int32_t& gas,
...
uint8_t mixTempSens_Class::getI2CAddress() const {
  /*!
...
uint8_t mixTempSens_Class::readSensors(const bool waitSwitch) {
...
void mixTempSens_Class::waitForReadings() const {
  /*!
...
bool mixTempSens_Class::setGas(uint16_t GasTemp, uint16_t GasMillis) const {
  /*!
...
bool mixTempSens_Class::measuring() const {
  /*!
...
void mixTempSens_Class::triggerMeasurement() const {
  /*!
